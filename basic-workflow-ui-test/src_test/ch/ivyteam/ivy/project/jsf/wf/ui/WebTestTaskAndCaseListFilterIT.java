...
class WebTestTaskAndCaseListFilterIT extends BaseWorkflowUiTest
{
  @Test
  void caseFilter()
  {
  ...
  @Test
  void taskAdminResponsibleFilter()
  {
    ...
    String tableBodyId = "taskListComponent:taskListForm:taskTable";
