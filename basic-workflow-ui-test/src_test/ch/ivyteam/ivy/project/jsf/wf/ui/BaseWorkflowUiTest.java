...
{
  public static final String WEB_TEST_SERVER_ADMIN_USER = "Administrator";
  public static final String WEB_TEST_SERVER_ADMIN_PASSWORD = "administrator";
  ...
  protected String jsfLinkId()
  {
    return URI.create(EngineUrl.createProcessUrl("testWfUi/13F3D94E5C99F06F/WfJsf.ivp")).getPath();
  }
  
  private String htmlLinkId()
  {
    return URI.create(EngineUrl.createProcessUrl("testWfUi/13F3D94AF2F236BF/WfHtml.ivp")).getPath();
  }
  ...
  {
    WfNavigator.processList();
    awaitToBeClickable(htmlLinkId()).click();
    switchToIFrame();
