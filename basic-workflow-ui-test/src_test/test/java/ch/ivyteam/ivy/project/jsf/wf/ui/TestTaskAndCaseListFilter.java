...
public class TestTaskAndCaseListFilter extends BaseWorkflowUiTest
{
  ...
  public void testFilterWithPagination() throws Exception
  {
    ...
    {
      WfNavigator.openProcessLink("basic-workflow-ui-test/145A7190339D94FD/start.ivp");
    }
    ...
    WfNavigator.openProcessLink("basic-workflow-ui-test/1466BC6311E70117/DestroyTasks.ivp");
  }
