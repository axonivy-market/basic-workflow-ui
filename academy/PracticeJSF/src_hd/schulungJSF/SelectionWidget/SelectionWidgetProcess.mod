[Ivy]
[>Created: Fri Oct 02 16:13:52 CEST 2015]
150286006388E3B4 3.17 #module
>Proto >Proto Collection #zClass
Ss0 SelectionWidgetProcess Big #zClass
Ss0 RD #cInfo
Ss0 #process
...
>Proto Ss0 Ss0 SelectionWidgetProcess #zField
Ss0 f0 guid 1502860064D2FBDF #txt
Ss0 f0 type schulungJSF.SelectionWidget.SelectionWidgetData #txt
Ss0 f0 method start(schulungJSF.ColorOrder) #txt
Ss0 f0 disableUIEvents true #txt
Ss0 f0 inParameterDecl 'ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent methodEvent = event as ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent;
<schulungJSF.ColorOrder preSelection> param = methodEvent.getInputArguments();
' #txt
Ss0 f0 inParameterMapAction 'out.colorOrder=param.preSelection;
out.colorOrder.color=null;
' #txt
Ss0 f0 outParameterDecl '<schulungJSF.ColorOrder colorOrder> result;
' #txt
...
<elementInfo>
    <language>
        <name>start(SelectOneWidgetsData)</name>
        <nameStyle>27,5,7
</nameStyle>
    </language>
</elementInfo>
' #txt
Ss0 f0 83 51 26 26 -80 15 #rect
Ss0 f0 @|RichDialogInitStartIcon #fIcon
Ss0 f1 type schulungJSF.SelectionWidget.SelectionWidgetData #txt
Ss0 f1 339 51 26 26 0 12 #rect
Ss0 f1 @|RichDialogProcessEndIcon #fIcon
Ss0 f3 guid 1502860065898EAD #txt
Ss0 f3 type schulungJSF.SelectionWidget.SelectionWidgetData #txt
Ss0 f3 actionDecl 'schulungJSF.SelectionWidget.SelectionWidgetData out;
' #txt
...
Ss0 f4 type schulungJSF.SelectionWidget.SelectionWidgetData #txt
Ss0 f4 guid 15028600658C6A82 #txt
Ss0 f4 211 147 26 26 0 12 #rect
Ss0 f4 @|RichDialogEndIcon #fIcon
Ss0 f5 expr out #txt
Ss0 f5 109 160 211 160 #arcP
Ss0 f8 actionDecl 'schulungJSF.SelectionWidget.SelectionWidgetData out;
' #txt
...
Ss0 f8 type schulungJSF.SelectionWidget.SelectionWidgetData #txt
...
>Proto Ss0 .type schulungJSF.SelectionWidget.SelectionWidgetData #txt
