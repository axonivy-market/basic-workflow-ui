[Ivy]
[>Created: Wed Sep 30 14:10:26 CEST 2015]
1501D82D3237D168 3.17 #module
>Proto >Proto Collection #zClass
Kg0 Kontakterfassung Big #zClass
Kg0 B #cInfo
Kg0 #process
...
>Proto Kg0 Kg0 Kontakterfassung #zField
Kg0 f0 outLink start.ivp #txt
Kg0 f0 type schulungJSF.KontaktData #txt
Kg0 f0 inParamDecl '<> param;' #txt
Kg0 f0 actionDecl 'schulungJSF.KontaktData out;
' #txt
...
Kg0 f1 type schulungJSF.KontaktData #txt
...
Kg0 f3 richDialogId schulungJSF.Kontakterfassung #txt
Kg0 f3 startMethod start(schulungJSF.Kontakt,schulungJSF.Company) #txt
Kg0 f3 type schulungJSF.KontaktData #txt
Kg0 f3 requestActionDecl '<schulungJSF.Kontakt kontakt, schulungJSF.Company company> param;' #txt
Kg0 f3 requestMappingAction 'param.kontakt=in.kontakt;
param.company=in.company;
' #txt
Kg0 f3 responseActionDecl 'schulungJSF.KontaktData out;
' #txt
Kg0 f3 responseMappingAction 'out=in;
out.company=result.company;
out.kontakt=result.kontakt;
' #txt
...
>Proto Kg0 .type schulungJSF.KontaktData #txt
