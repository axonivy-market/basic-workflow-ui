...
Wf0 @UserDialog f3 '' #zField
Wf0 @UserDialog f4 '' #zField
...
Wf0 f3 dialogId ch.ivyteam.wf.test.RequestDialog #txt
...
Wf0 f3 @|UserDialogIcon #fIcon
Wf0 f3 -1|-1|-9671572 #nodeStyle
Wf0 f4 dialogId ch.ivyteam.wf.test.ConfirmationDialog #txt
