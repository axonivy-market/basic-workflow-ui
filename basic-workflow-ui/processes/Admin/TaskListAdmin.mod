...
>Proto Tn0 Tn0 TaskListAdmin #zField
Tn0 f0 outLink TaskListAdmin.ivp #txt
Tn0 f0 inParamDecl '<> param;' #txt
Tn0 f0 requestEnabled true #txt
Tn0 f0 triggerEnabled false #txt
Tn0 f0 callSignature TaskListAdmin() #txt
...
Tn0 f0 81 49 30 30 -50 17 #rect
Tn0 f0 @|StartRequestIcon #fIcon
Tn0 f1 369 49 30 30 0 15 #rect
Tn0 f1 @|EndIcon #fIcon
Tn0 f3 dialogId ch.ivyteam.wf.admin.TaskListAdmin #txt
...
<elementInfo>
    <language>
        <name>Task List Admin</name>
        <nameStyle>15,7
</nameStyle>
    </language>
</elementInfo>
' #txt
Tn0 f3 200 42 112 44 -44 -8 #rect
